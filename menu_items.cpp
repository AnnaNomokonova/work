...
"0 - Выйти в предыдущее меню", AnnaN::read_pushkin_go_back, &AnnaN::READ_PUSHKIN
}; 

namespace {
const AnnaN::MenuItem* const pushkin_children[] = {
&AnnaN::READ_PUSHKIN_DUBROVSKY,
&AnnaN::REAN_PUSHKIN_EVGENY_ONEGIN,
...
"1 - Читать Пушкина", AnnaN::read_pushkin, &AnnaN::READ
};
...
"4 - Выйти в главное меню", AnnaN::read_go_back, &AnnaN::READ
};
