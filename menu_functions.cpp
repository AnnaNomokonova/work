...
const AnnaN::MenuItem*  AnnaN::ru_writers(const MenuItem* current) {
//TODO
...
const AnnaN::MenuItem* AnnaN::read_go_back(const MenuItem* current) {
//TODO
std::cout << current->title << std::endl;
...
const AnnaN::MenuItem* AnnaN::read_pushkin_go_back(const MenuItem* current) {
//TODO
std::cout << current->title << std::endl;
return current->parent->parent;
}
